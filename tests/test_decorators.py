...
# from amiqus.decorators import _hmac, _match, verify_signature
...
# TEST_REQUEST_BODY = (
#     b'{"payload":{"resource_type":"record","action":"record.started",'
...
#
#  These tests are all commented out until we can be certain about the amiqus webhook signature verification pattern.
#

# class DecoratorTests(TestCase):
#     """amiqus.decorator module tests."""
...
#         with mock.patch("amiqus.decorators._hmac") as mock_hmac:
...
#     @mock.patch("amiqus.decorators._match")
